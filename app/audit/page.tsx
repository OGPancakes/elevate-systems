...
export default function AuditPage() {
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <SiteHeader />
      <section className="relative mx-auto max-w-7xl px-5 pb-6 pt-32">
        ...
        <h1 className="mt-3 max-w-4xl text-4xl font-semibold leading-tight text-white sm:text-6xl">
          Give business owners a polished AI preview of what their website could become.
        </h1>
        <p className="mt-5 max-w-2xl leading-8 text-white/60">
          Elevate Bot scans their current site, captures the lead, generates a concise audit,
          and points qualified prospects toward a strategy call.
        </p>
      </section>
      <WebsiteAudit />
      <ElevateBot />
