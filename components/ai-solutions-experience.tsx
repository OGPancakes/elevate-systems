        ...
        <div className="mx-auto mt-10 grid max-w-5xl auto-rows-fr gap-4 lg:grid-cols-[1.05fr_0.95fr]">
          {solutionTiers.map((tier) => (
            <article className={`relative flex h-full flex-col border p-6 ${tier.featured ? "border-sky-300/50 bg-sky-300/[0.07]" : "border-white/10 bg-white/[0.025]"}`} key={tier.id}>
              ...
              <div className="mt-6 grid overflow-hidden border border-white/10 bg-white/[0.04]">
                <div className="border-b border-white/10 bg-[#07101d] p-5">
                  <p className="text-xs uppercase tracking-[0.16em] text-white/35">Setup fee</p>
                  <p className="mt-2 whitespace-nowrap text-[clamp(2.1rem,6vw,2.9rem)] font-semibold leading-none text-white">{tier.setupRange}</p>
                ...
                <div className="bg-[#07101d] p-5">
                  ...
                  <p className="mt-2 text-[clamp(2.1rem,6vw,2.9rem)] font-semibold leading-none text-white">
                    {tier.monthlyRange.replace("/mo", "")}
                    <span className="block pt-2 text-sm font-medium leading-none text-white/45">per month</span>
                  </p>
